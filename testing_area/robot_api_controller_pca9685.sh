#!/usr/bin/env python3
"""
Compatibility launcher for the unified robot API using the PCA9685 driver.
This script keeps the previous entry-point name while delegating to the shared
FastAPI application and configuration file.
"""
...
def main() -> None:
    ...
    os.environ["ROBOT_SERVO_DRIVER"] = "pca9685"
